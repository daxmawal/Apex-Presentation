...
\begin{lstlisting}[language=C++,basicstyle=\ttfamily\tiny,backgroundcolor=\color{white},numbers=none,frame=none,showstringspaces=false,columns=fullflexible,escapeinside={(*@}{@*)}]
Kokkos::parallel_for("GhostCommunicator_partial_blocks::list_send_cells",
  ...
  KOKKOS_LAMBDA((*@{\color{black}\ttfamily\tiny \detokenize{const}}@*) Kokkos::TeamPolicy<>::member_type& team)
{
