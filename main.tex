...
\begin{itemize}\itemsep0.12em
    ...
    \item This matches the next slide: APEX reports candidates for both knobs.
\end{itemize}
\end{frame}
...
\begin{semiverbatim}
  ...
  -tv: [..._vector_length:0.04995, ..._team_size:0.04995]
...
\begin{itemize}\itemsep0.12em
    ...
    \item \textpdfrender{TextRenderingMode=FillStroke,LineWidth=0.18pt}{\textcolor{red!80!black}{\textbf{So the next Dyablo run cannot yet reload one final winning configuration from this YAML. Part of the next run will replay candidates already seen in the previous one.}}}
\end{itemize}
\end{frame}
