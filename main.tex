...
\begin{itemize}\itemsep0.3em
    ...
    \item Reuses converged configurations and can write them to YAML
\end{itemize}
\end{beamerboxesrounded}
\end{frame}
...
\item \textpdfrender{TextRenderingMode=FillStroke,LineWidth=0.18pt}{\textcolor{red!80!black}{\textbf{So the next Dyablo run cannot yet reload one final winning configuration from this YAML, and APEX will start tuning this context again from scratch.}}}
\end{itemize}
\end{frame}
